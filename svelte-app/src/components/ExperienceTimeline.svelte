<script lang="ts">
	...
	// Action to handle intersection observer for each element
...
<section class="relative py-24 bg-gray-900 overflow-hidden min-h-screen">
	...
	<div
		...
		style="background-color: {activeBrandColor || '#000'}; opacity: {activeBrandColor ? 0.15 : 0};"
	></div>
				...
				>
					...
					<div class="w-full md:w-[45%] relative group">
						<div
							...
							on:mouseleave={() => (activeBrandColor = null)}
							role="group"
						>
							<div class="flex flex-col">
								...
								<h3
									class="text-2xl font-bold text-white mb-1 transition-colors group-hover:text-(--brand-color)"
